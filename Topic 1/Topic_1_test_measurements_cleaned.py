...
# Print results
print(f"Total operation_ids: {total_operations} (total tests: {total_tests_all})")
print(f"Operation_ids with 0% passed: {num_zero} (total tests: {tests_zero})")
print(f"Operation_ids with 100% passed: {num_hundred} (total tests: {tests_hundred})")
...
# Print results
print(f"Total dut_sn: {total_duts} (total tests: {total_tests_all_dut})")
print(f"dut_sn with 0% passed: {num_zero_dut} (total tests: {tests_zero_dut})")
print(f"dut_sn with 100% passed: {num_hundred_dut} (total tests: {tests_hundred_dut})")
...
# Print results
print(f"dut_sn with 0-5% passed: {num_low_pass_dut} (total tests: {tests_low_pass_dut})")
print(f"dut_sn with 95-100% passed: {num_high_pass_dut} (total tests: {tests_high_pass_dut})\n")
...
# Print results
print(f"Filtered - Total dut_sn: {total_duts_f} (total tests: {total_tests_all_dut_f})")
print(f"Filtered - dut_sn with 0% passed: {num_zero_dut_f} (total tests: {tests_zero_dut_f})")
print(f"Filtered - dut_sn with 100% passed: {num_hundred_dut_f} (total tests: {tests_hundred_dut_f})")
...
# Print results
print(f"Filtered - dut_sn with 0-5% passed: {num_low_pass_dut} (total tests: {tests_low_pass_dut})")
print(f"Filtered - dut_sn with 95-100% passed: {num_high_pass_dut} (total tests: {tests_high_pass_dut})\n")
